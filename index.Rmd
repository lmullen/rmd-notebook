...
1. Incldues an index page (you're looking at it).
2. Creates a table of contents for every `.Rmd` file in the root directory of your project.
3. Inserts a link into each rendered HTML file back to the index and to the repository (if you want).
4. Sets some shared options for rendering HTML from R Markdown.
